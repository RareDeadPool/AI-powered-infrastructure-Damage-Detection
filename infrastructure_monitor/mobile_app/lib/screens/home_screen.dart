        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                gradient: const LinearGradient(colors: [Color(0xFFF38020), Color(0xFF2D5096)]),
                boxShadow: [
                  BoxShadow(color: const Color(0xFF2D5096).withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 10))
                ],
              ),
              child: const Center(
                child: Text(
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: const [
              Text('SPECIALIZED ANALYSIS', style: TextStyle(color: Color(0xFFF38020), fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
              SizedBox(height: 4),
